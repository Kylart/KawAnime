...
// Setup the api
require(path.join(__dirname, 'main', 'server'))(app)
...
const menuFile = require('./main/resources/menu.js')
...
Electron.on('ready', () => {
  ...
  if (localConfig.system.toTray) {
    ...
    tray = new Tray('./main/resources/tray.png')
...
Electron.on('quit', () => {
  ...
  const dir = require(path.join(__dirname, 'main', 'server', 'utils', 'dir.js'))
